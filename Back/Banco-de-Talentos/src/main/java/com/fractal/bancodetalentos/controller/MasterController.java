...
public class MasterController {
    ...
    @PostMapping("/general")
    public ResponseEntity<GeneralDataResp> findGeneralData() {
        GeneralDataResp dataResp = masterService.getGeneralData();
        if (dataResp == null) {
            throw new ResourceNotFoundException("General data");
        }
