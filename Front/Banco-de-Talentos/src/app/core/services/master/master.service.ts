...
export class MasterService {
  ...
  getLanguages(): Observable<MasterModels.LanguageModel[]> {
    return this.httpClient.get<MasterModels.LanguageModel[]>(UrlConstants.URL_REQ_LANG);
  }

  getRoles(): Observable<MasterModels.RoleModel[]> {
    return this.httpClient.get<MasterModels.RoleModel[]>(UrlConstants.URL_REQ_ROLES);
  }

  getCurrencies(): Observable<MasterModels.CurrenciesModel[]> {
    return this.httpClient.get<MasterModels.CurrenciesModel[]>(UrlConstants.URL_REQ_CURRS);
  }

  getProfiles(): Observable<MasterModels.ProfileModel[]> {
    return this.httpClient.get<MasterModels.ProfileModel[]>(UrlConstants.URL_REQ_PROF);
  }

  getLangProficiency(): Observable<MasterModels.LangProficiencyModel[]> {
    return this.httpClient.get<MasterModels.LangProficiencyModel[]>(UrlConstants.URL_REQ_LANG_PROF);
  }

  getCountries(): Observable<MasterModels.CountryModel[]> {
    return this.httpClient.get<MasterModels.CountryModel[]>(UrlConstants.URL_REQ_COUNTRIES);
  }
